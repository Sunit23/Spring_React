...
public class ProjectCoreDao {
	...
	public ProjectCoreDao() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ProjectCoreDao(String ruleChecksum, String modifiedDate, String status, String statusDate, String test) {
		super();
		this.ruleChecksum = ruleChecksum;
		this.modifiedDate = modifiedDate;
		this.status = status;
